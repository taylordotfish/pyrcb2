...
This documentation is for pyrcb2 version **0.6.1**.
See the :doc:`changelog <release-notes/0.6>`
for information about this version.

Source code for pyrcb2 and this documentation is available at
`<https://github.com/taylordotfish/pyrcb2/tree/0.6.1/>`_.

.. _examples: https://github.com/taylordotfish/pyrcb2/tree/0.6.1/examples/
...
.. toctree::
   ...
   custom-commands
   release-notes/index
   Source code <https://github.com/taylordotfish/pyrcb2/tree/0.6.1/>
   Examples <https://github.com/taylordotfish/pyrcb2/tree/0.6.1/examples/>
   License <https://github.com/taylordotfish/pyrcb2/blob/0.6.1/LICENSE>
