...
This documentation is for pyrcb2 version **0.6.0**.
...
`<https://github.com/taylordotfish/pyrcb2/tree/0.6.0/>`_.

.. _examples: https://github.com/taylordotfish/pyrcb2/tree/0.6.0/examples/
...
.. toctree::
   ...
   custom-commands
   release-notes/index
   Source code <https://github.com/taylordotfish/pyrcb2/tree/0.6.0/>
   Examples <https://github.com/taylordotfish/pyrcb2/tree/0.6.0/examples/>
   License <https://github.com/taylordotfish/pyrcb2/blob/0.6.0/LICENSE>
